const workoutinfo = [
  ...
  ///aditional endomorph
  {
    ...
    "instructions": [
      ...
      "Cool down with 5-10 minutes of light walking and stretching."
    ],
    "images": [
      "path/to/sprint-intervals-1.jpg",
      "path/to/sprint-intervals-2.jpg"
    ],
    "id": "hiit_sprint_intervals"
  },
  {
    ...
    "difficulty": "intermediate",
    "instructions": [
      "Perform squats with a barbell for 10-12 reps.",
      "Rest for 30 seconds.",
      "Move to bench presses for 10-12 reps.",
      "Rest for 30 seconds.",
      "Complete deadlifts for 10 reps.",
      "Rest for 30 seconds.",
      "Repeat this circuit 3-4 times."
    ],
    "images": [
      "path/to/compound-circuit-1.jpg",
      "path/to/compound-circuit-2.jpg"
    ],
    "id": "compound_strength_circuit"
  },
  {
    ...
    "difficulty": "beginner",
    "instructions": [
      "Adjust the resistance on the rowing machine to a comfortable level.",
      "Sit down and secure your feet in the straps.",
      "Grab the handle with both hands and begin rowing using your legs, then back, and arms.",
      "Row continuously for 20-30 minutes at a moderate pace.",
      "Cool down by rowing slowly for 5 minutes and stretching after."
    ],
    "images": [
      "path/to/rowing-machine-1.jpg",
      "path/to/rowing-machine-2.jpg"
    ],
  ...
  },
  {
    ...
    "images": [
      "path/to/bodyweight-circuit-1.jpg",
      "path/to/bodyweight-circuit-2.jpg"
    ],
  ...
  },
  {
    ...
    "difficulty": "intermediate",
    "instructions": [
      "Start with a warm-up lap at an easy pace.",
      "Swim freestyle for 5-10 laps at a moderate to fast pace.",
      "Take 1-2 minutes of rest between sets.",
      "Repeat for a total of 20-30 minutes.",
      "Cool down with a slow-paced lap and stretching."
    ],
    "images": [
      "path/to/swimming-laps-1.jpg",
      "path/to/swimming-laps-2.jpg"
    ],
    "id": "swimming_laps"
  },
  {
    ...
    "difficulty": "beginner",
    "instructions": [
      "Start with simple stretches like cat-cow and forward fold.",
      "Move into downward dog and hold for 30 seconds.",
      "Transition to warrior poses and hold each for 30 seconds.",
      "End with child’s pose for 1-2 minutes and deep breathing."
    ],
    "images": [
      "path/to/yoga-1.jpg",
      "path/to/yoga-2.jpg"
  ...
  {
    "name": "Circuit Training with Dumbbells",
    "type": "strength",
    "body-type": "Endomorph",
    "muscle": "multiple",
    "equipment": "dumbbells",
    "difficulty": "intermediate",
    "instructions": [
      "Start with 12-15 dumbbell shoulder presses.",
      "Transition into 15 goblet squats holding a single dumbbell.",
      "Perform 12-15 bent-over rows with a dumbbell in each hand.",
      "Finish with 15 dumbbell lunges (each leg).",
      "Rest for 1-2 minutes and repeat the circuit for 3-4 rounds."
    ],
    "images": [
      "path/to/dumbbell-circuit-1.jpg",
      "path/to/dumbbell-circuit-2.jpg"
    ],
    "id": "circuit_training_dumbbells"
  },
  {
    "name": "Stair Climbing",
    "type": "cardio",
    ...
    "difficulty": "beginner",
    "instructions": [
      "Start by walking up and down the stairs at a moderate pace for 5 minutes to warm up.",
      "Increase the speed for 10-15 minutes, alternating between quick steps and slower recovery steps.",
      "Cool down by walking at a slow pace for 5 minutes."
    ],
    "images": [
      "path/to/stair-climbing-1.jpg",
      "path/to/stair-climbing-2.jpg"
    ],
    "id": "stair_climbing"
  },
  {
    ...
    "type": "cardio",
    "body-type": "Endomorph",
    "muscle": "upper body, core",
    "equipment": "battle ropes",
    "difficulty": "intermediate",
    "instructions": [
      "Grip the ends of the battle ropes and stand with feet shoulder-width apart.",
      "Bend your knees slightly and engage your core.",
      "Move the ropes up and down rapidly for 20-30 seconds.",
      "Rest for 30 seconds and repeat for 5-10 rounds."
    ],
    "images": [
      "path/to/battle-ropes-1.jpg",
      "path/to/battle-ropes-2.jpg"
    ],
    "id": "battle_ropes"
  },
  {
    ...
    "difficulty": "intermediate",
    "instructions": [
      "Start with 15 bodyweight squats or squats holding dumbbells.",
      "Follow with 12-15 lunges on each leg.",
      "Perform 15 calf raises.",
      "Rest for 1 minute and repeat the circuit 3-4 times."
    ],
    "images": [
      "path/to/leg-circuit-1.jpg",
      "path/to/leg-circuit-2.jpg"
    ],
    "id": "leg_circuit"
  },
  {
    ...
    "instructions": [
      ...
      "Alternate between 1 minute of high-intensity effort and 2 minutes of moderate pace.",
      "Continue for 20-30 minutes.",
      "Cool down with 5 minutes of easy pace and stretching."
    ],
    "images": [
      "path/to/elliptical-hiit-1.jpg",
      "path/to/elliptical-hiit-2.jpg"
    ],
    "id": "elliptical_hiit"
  },
  {
    ...
    "difficulty": "intermediate",
    "instructions": [
      "Stand in front of a sturdy plyo box or platform.",
      "Bend your knees slightly and jump onto the box, landing softly with both feet.",
      "Step down and repeat for 10-15 reps.",
      "Rest for 30-60 seconds and complete 3-4 sets."
    ],
    "images": [
      "path/to/box-jumps-1.jpg",
      "path/to/box-jumps-2.jpg"
    ],
    "id": "box_jumps"
  },
  {
    ...
    "instructions": [
      ...
      "Alternate legs rapidly for 30-60 seconds.",
      "Rest for 30 seconds and repeat for 5-10 rounds."
    ],
    "images": [
      "path/to/mountain-climbers-1.jpg",
      "path/to/mountain-climbers-2.jpg"
    ],
    "id": "mountain_climbers"
  }
]
